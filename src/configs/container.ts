...
bind<BaseCommand>(TYPES.Command).to(applicationCommands.InfractionsCommand)
  .whenTargetTagged('command', 'infractions')
...
bind<structures.Infraction>(TYPES.Structure).to(structures.Infraction)
  .whenTargetNamed('Infraction')
